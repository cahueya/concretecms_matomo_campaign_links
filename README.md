...
Adds a frontend toolbar button for editors. Clicking it opens a native concreteCMS dialog with generated Matomo campaign links for the current page.
...
Add one row per parameter series. Each row contains: active, source, medium and content. Key and label are generated automatically from medium and content.
